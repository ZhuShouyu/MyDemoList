...
@synthesize customAttributedText = _customAttributedText;
...
- (CFIndex)characterIndexAtPoint:(CGPoint)point {
    ...
    NSMutableAttributedString* optimizedAttributedText = [self.customAttributedText mutableCopy];
    
    [self.customAttributedText enumerateAttribute:(NSString*)kCTParagraphStyleAttributeName inRange:NSMakeRange(0, [optimizedAttributedText length]) options:0 usingBlock:^(id value, NSRange range, BOOL *stop) {
    ...
    CTFrameRef frame = CTFramesetterCreateFrame(framesetter, CFRangeMake(0, [self.customAttributedText length]), path, NULL);
